...
public final class RevivalConfig {
    ...
    static {
        ...
        REVIVED_HEALTH_HALF_HEARTS = builder.comment("Health after revival, measured in half-hearts.")
                .defineInRange("revivedHealthHalfHearts", 2, 1, 40);
        RECOVERY_TICKS = builder.comment("Weakness and slowness duration after revival.")
